...
/**
 * Read and pass on data stdin in utf-8 (cross-platform).
 * @param {Function} callback The callback to pass code once the stdin stream has collected all data from user.
 * @returns {String} sourceCode The source code to be linted.
 */
function getSourceCodeFromStdin (callback) {
	var sourceCode = '';
